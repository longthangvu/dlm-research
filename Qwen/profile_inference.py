...
def _load_model(model_path: str, offload_dir: Optional[str], do_compile: bool):
...
def run_profile(
    ...
    model = _load_model(model_path=model_path, offload_dir=offload_dir, do_compile=do_compile)
    tokenizer = None
